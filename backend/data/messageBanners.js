...
const BANNER_PRESETS = {
  ...
  powerGenerationPsu: {
    ...
    accentColor: '#b45309',
    overlayColor: '#1c1917',
    imageUrl: 'https://images.unsplash.com/photo-1466611653911-95081537e5b7?w=1200&q=80',
    heroHeight: 280,
    textAlign: 'left',
    showCta: false,
    showHeader: true,
  ...
  industrialAssoc: {
    ...
    accentColor: '#b45309',
    overlayColor: '#1c1917',
    imageUrl: 'https://images.unsplash.com/photo-1515187029135-18ee286d815b?w=1200&q=80',
    heroHeight: 280,
    textAlign: 'left',
    showCta: false,
    showHeader: true,
